...
import Shutupinvest from '~assets/images/shutupinvest.png'
...
export default ({ onGetStart }) => (
  <Row className="hero-container container shutupinvest">
    <Col xs={12} md={12} lg={4} className="left">
      <div className="team">
        <img src={Shutupinvest} alt="Shutupinvest" className="shutupinvest" />
